...
with st.sidebar:
    ...
    # -----------------------------------------------------
    # FIX: Step 2: Google Drive Authentication
    # -----------------------------------------------------
    ...
    if not st.session_state.basecamp_token: 
        ...
        if st.session_state.gdrive_creds:
            ...
            # 1. Initialize the flow and URL only if they don't exist in session_state
