...
#     """
#     Parses Markdown-like text and adds it to a Docx table cell 
#     with professional formatting, spacing, and bolding.
#     """
...
#         # Reuse the first paragraph if it's the first line, otherwise add new
#         if is_first_line:
#             is_first_line = False
#         else:
        ...
        if st.session_state.gdrive_creds:
            ...
            if st.button("Logout Drive"):
                ...
                if 'flow' in st.session_state: 
                    del st.session_state.flow # Clean up flow on logout
                st.rerun()
        else:
            # Initialize the flow only if it doesn't exist in session_state
            ...
            # Use the persistent flow from session_state to get the URL
            url, _ = st.session_state.flow.authorization_url(prompt='consent')
